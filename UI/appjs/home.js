...
angular.module('PMAPP').controller('HomeController', ['$http', '$log', '$scope', '$rootScope', '$location',
    function($http, $log, $scope, $rootScope, $location) {
        ...
        this.loadParts = function(){
            ...
            $http.get(url).then(// success call back
                ...
                // into the list of parts in the controller.
                    ...
                    thisCtrl.partList = response.data.Likes;
        ...
        this.updateTrending = function(){
            // Get the list of parts from the servers via REST API

            // First set up the url for the route
            var url = "http://localhost:5000/PhotoMessagingApp/statistics/trending";
            ...
            $http.get(url).then(// success call back
                ...
                // into the list of parts in the controller.
                    ...
                    thisCtrl.trendingTopics = response.data.Trending;
                    $rootScope.prueba = "Proando";
            }, // error callback
            function (response){
                // This is the error function
